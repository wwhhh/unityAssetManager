...
namespace Path.Editor
{
    [CustomEditor(typeof(PathSmooth))]
    internal sealed class CinemachineSmoothPathEditor : BaseEditor<PathSmooth>
    {
        ...
        void DrawWaypointEditor(Rect rect, int index)
        {
            ...
            //PathSmooth.Waypoint def = new PathSmooth.Waypoint();
            ...
            EditorGUI.PropertyField(r, element.FindPropertyRelative("roll"), rollLabel);
            ...
            if (GUI.Button(r, setButtonContent, GUI.skin.label) && SceneView.lastActiveSceneView != null)
            {
                ...
                PathSmooth.Waypoint wp = Target.m_Waypoints[index];
        ...
        void InsertWaypointAtIndex(int indexA)
        {
            ...
            var wp = new PathSmooth.Waypoint();
            wp.position = pos;
            wp.roll = roll;
            var list = new List<PathSmooth.Waypoint>(Target.m_Waypoints);
        ...
        {
            PathSmooth.Waypoint wp = Target.m_Waypoints[i];
        ...
        [DrawGizmo(GizmoType.Active | GizmoType.NotInSelectionHierarchy
             | GizmoType.InSelectionHierarchy | GizmoType.Pickable, typeof(PathSmooth))]
        static void DrawGizmos(PathSmooth path, GizmoType selectionType)
        {
           PathEditor.DrawPathGizmo(path,
