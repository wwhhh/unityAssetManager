...
namespace Path.Editor
{
    ...
    internal sealed class PathEditor : BaseEditor<Path>
    {
        ...
        void DrawWaypointEditor(Rect rect, int index)
        {
            ...
            //Path.Waypoint def = new Path.Waypoint();
            ...
            if (GUI.Button(r, buttonContent, style) && SceneView.lastActiveSceneView != null)
            {
                ...
                Path.Waypoint wp = Target.m_Waypoints[index];
            ...
            if (GUI.Button(r, buttonContent, style))
            {
                ...
                var list = new List<Path.Waypoint>(Target.m_Waypoints);
                list.RemoveAt(index);
        ...
        {
            Path.Waypoint wp = Target.m_Waypoints[i];
        ...
        public static void DrawPathGizmo(PathBase path, Color pathColor)
        {
            // Draw the path
        ...
        static void DrawGizmos(Path path, GizmoType selectionType)
        {
            DrawPathGizmo(path,
